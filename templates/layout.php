...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <?php $classname = ($is_auth === 1) ? "" : "visually-hidden";?>
        <a class="main-header__add-lot button <?=$classname ?>" href="add.php">Добавить лот</a>
...
<footer class="main-footer">
    ...
    <div class="main-footer__bottom container">
        ...
        <?php $classname = ($is_auth === 1) ? "" : "visually-hidden";?>
        <a class="main-footer__add-lot button <?=$classname ?>" href="add.php">Добавить лот</a>
